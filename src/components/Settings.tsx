	...
	return (<div className={"Settings"+ (isOpen?' open':'')}>
			...
			<div className="container">
				...
				<div className="tipping">
					<p>Like this tool?</p>
					<a href='https://ko-fi.com/F1F316CY21' target='_blank'><img height='36' style={{border: '0px', height: '36px'}} src='https://storage.ko-fi.com/cdn/kofi1.png?v=6'  alt='Buy Me a Coffee at ko-fi.com' /></a>
				</div>
			</div>
	</div>)
}